...
NGROK_URL = 'https://mercy-limitless-preceptorially.ngrok-free.dev'  # Set this when you start ngrok
...
# Business shortcode for Lipa na M-Pesa Online (using standard sandbox shortcode)
